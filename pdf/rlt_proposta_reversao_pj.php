...
$pdf->SetX($x);
   ...
   $pdf->SetFont('Arial','B', 10);
   $pdf->Cell(170,5,'OBSERVAÇÕES E DECLARAÇÕES',0,1,'C');
   ...
   $pdf->SetX($x);
   $pdf->SetFont('Arial','', 8);
   $pdf->MultiCell(180,$l,utf8_decode("No caso de reversão de bilheteria, fica sujeito ao atendimento no disposto nas Leis municipais no 10.973/91, regulamentada pelo Decreto Municipal n° 30.730/91; 11.113/91; 11.357/93 e 12.975/2000 e portaria nº 66/SMC/2007; Leis Estaduais nº 7.844/92, regulamentada pelo Decreto Estadual nº 35.606/92; 10.858/2001, alterada pela Lei Estadual 14.729/2012 e Medida Provisória Federal 12.933/2013 e Lei Federal nº 10.741/2003 (Estatuto do Idoso)."));
   
   $pdf->SetX($x);
   $pdf->SetFont('Arial','', 8);
   $pdf->MultiCell(180,$l,utf8_decode("Nos casos de lançamento de CD ou outro produto artístico-cultural, assumo inteira responsabilidade fiscal e tributária quanto a sua comercialização, isentando a Municipalidade de quaisquer ônus ou encargos , nos termos da O.I. n o 01/2002 – SMC-G. No caso de espetáculo musical, declaro assumir quaisquer ônus decorrentes da fiscalização e autuação da Ordem dos Músicos do Brasil - OMB."));
   
   $pdf->SetX($x);
   $pdf->SetFont('Arial','', 8);
   $pdf->MultiCell(180,$l,utf8_decode("Declaro que não temos débitos perante as Fazendas Públicas, Federal, Estadual e, em especial perante a Prefeitura do Município de São Paulo.
...
Declaro que estou ciente de que do valor do serviço serão descontados os impostos cabíveis.
Declaro que estou ciente de que é vedada a colocação de anúncios (lambe-lambe e similares) com base na legislação municipal existente que disciplina a matéria.
Declaro que no caso de apresentação de espetáculo (s) de dança, estamos cientes de que é de nossa responsabilidade providenciar operador (es) de som e luz.
