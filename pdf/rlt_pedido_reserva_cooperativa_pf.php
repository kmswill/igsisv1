...
$sei = 
  "<p align='right' class='style_01'>Folha de Informação nº ___________</p>".
  ...
  "<p>&nbsp;</p>".
  "<p>Encaminho o presente a Vossa Senhoria para a necessária reserva de recursos no valor supra citado mais o valor do INSS Patronal que deverá onerar a dotação pertinente.</p>".
  "<p>&nbsp;</p>".
