...
$sei = 
  ...
  "<p>&nbsp;</p>".
  "<p>Encaminho o presente a Vossa Senhoria para a necessária reserva de recursos no valor supra citado para o pagamento do cachê que deverá onerar a dotação do FEPAC.</p>".
  "<p>&nbsp;</p>".
