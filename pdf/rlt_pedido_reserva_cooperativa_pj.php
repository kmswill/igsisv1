...
$sei = 
  ...
  "<p>&nbsp;</p>".
  "<p>Encaminho o presente a Vossa Senhoria para a necessária reserva de recursos no valor supra citado mais o valor para o INSS Patronal que deverão onerar a dotação pertinente.</p>".
  "<p>&nbsp;</p>".
