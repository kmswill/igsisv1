...
$l=7; //DEFINE A ALTURA DA LINHA   
   ...
   $pdf->SetX($x);
   $pdf->SetFont('Arial','', 10);
   $pdf->MultiCell(180,$l,utf8_decode("Encaminho o presente a Vossa Senhoria para a necessária reserva de recursos com transferência de valor que deverá onerar a dotação pertinente (programação de atividades culturais 25.10.13.392.3001.6354.3390.3900)."));
