    ...
    <div class="container">
        ...
        <div class="form-group">
			...
			?>
	            ...
	            <a href="?perfil=juridico&p=frm_cadastra_juridico_pj&id_ped=<?php echo $id_ped ?>&idModelo=<?php echo $modelo['idModelo'] ?>" class="btn btn-theme btn-lg btn-block"><?php echo $modelo['nomeModelo'] ?></a> 
				<?php }
			?>				
            </div>
          </div>
