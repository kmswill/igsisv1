...
$Id_PedidoContratacaoPF=$_POST['Id_PedidoContratacaoPF'];
	  	...
	  	<div class="container">
	  		...
	  		<div class="row">
	  			<div class="col-md-offset-1 col-md-10">
                    ...
                    <form class="form-horizontal" role="form" action="?perfil=juridico&p=update_cadastra_juridicovocacional_pf&id_ped=<?php echo $_GET['id_ped']; ?>" method="post">				  <div class="form-group">
