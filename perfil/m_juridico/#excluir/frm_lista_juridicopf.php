...
$linha_tabela_lista = siscontratLista(1,"",1000,1,"DESC","todos"); //esse gera uma array com os pedidos

//$tipoPessoa,$num_registro,$pagina,$ordem,$estado

$link="index.php?perfil=juridico&p=frm_cadastra_juridicogeral_pf&id_ped=";
