...
$linha_tabela_lista = siscontratLista(1,"",2000,1,"DESC","todos"); //esse gera uma array com os pedidos

$link="index.php?perfil=pagamento&p=frm_cadastra_notaempenhopf&id_ped=";
