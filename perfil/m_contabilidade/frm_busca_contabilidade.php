...
<br />
	<section id="list_items">
		<div class="container">
             ...
             <h5><a href="?perfil=contabilidade&p=frm_busca_contabilidade">Fazer outra busca</a></h5>
...
for($h = 0; $h < $x['num']; $h++)
 {
	...
	if($x[$h]['tipo'] == 'Física'){
		echo "<tr><td class='lista'> <a href='?perfil=contabilidade&p=frm_cadastra_contabilpf&id_ped=".$x[$h]['id']."'>".$x[$h]['NumeroProcesso']."</a></td>";
	}else{
		echo "<tr><td class='lista'> <a href='?perfil=contabilidade&p=frm_cadastra_contabilpj&id_ped=".$x[$h]['id']."'>".$x[$h]['NumeroProcesso']."</a></td>";
...
<?php
	...
	<?php  geraOpcao("ig_modalidade","",""); ?>
            ...
            <div class="form-group">
            	<div class="col-md-offset-2 col-md-8">
            <h5><?php if(isset($mensagem)){ echo $mensagem; } ?>
            <form method="POST" action="?perfil=contabilidade&p=frm_busca_contabilidade&b=periodo" class="form-horizontal" role="form">
                <div class="form-group">
