...
$linha_tabela_lista = siscontratLista(1,"",10,1,"DESC","todos"); //esse gera uma array com os pedidos

//$tipoPessoa,$instituicao,$num_registro,$pagina,$ordem,$estado

$link="index.php?perfil=contabilidade&p=frm_cadastra_propostapf&id_ped=";
