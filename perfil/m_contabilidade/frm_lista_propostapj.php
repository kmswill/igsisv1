...
$linha_tabela_lista = siscontratLista(2,5,10,1,"DESC","todos"); //esse gera uma array com os pedidos

$link="index.php?perfil=contabilidade&p=frm_cadastra_propostapj&id_ped=";
