...
<p></p>
            ...
            <div class="form-group">
            	<div class="col-md-offset-2 col-md-8">
                        ...
                        <form method="POST" action="?perfil=contratos&p=frm_edita_representantelegal&pj=<?php echo $_GET['pj'] ?>&num=<?php echo $_GET['num'] ?>&id_rep=" class="form-horizontal" role="form">
