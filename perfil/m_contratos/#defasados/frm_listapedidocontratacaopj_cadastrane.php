...
$linha_tabela_lista = siscontratLista(2,$_SESSION['idInstituicao'],100,1,"DESC","Pedido de Reserva"); //esse gera uma array com os pedidos

$link="index.php?perfil=contratos&p=frm_cadastra_notaempenhopj&id_ped=";
