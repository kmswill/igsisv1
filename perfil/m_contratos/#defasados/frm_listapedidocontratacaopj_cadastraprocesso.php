...
$linha_tabela_lista = siscontratLista(2,"",1000,1,"DESC","Proposta"); //esse gera uma array com os pedidos

$link="index.php?perfil=contratos&p=frm_cadastra_processopj&id_ped=";
