...
<!-- Coordenador de Contratos -->
			   ...
			   <div class="form-group">
					<div class="col-md-offset-2 col-md-8"><strong>Responsável no Setor de Contratos Artísticos:</strong><br/>
			   ...
			   <div class="form-group">
					<div class="col-md-offset-2 col-md-6"><strong>Status:</strong><br/>
...
<!-- Fim -->		
				  <div class="form-group">
					<div class="col-md-offset-2 col-md-8"><strong>Código do Pedido de Contratação:</strong> <?php echo "$ano-$id_ped"; ?><br/>
		  ...
		  <form class="form-horizontal" role="form" action="?perfil=contratos&p=frm_grupos"  method="post">
               ...
               <!--                    <div class="form-group">
				...
				<?php } ?>   	
                  ...
                  <div class="form-group">
					<div class="col-md-offset-2 col-md-6"><strong>Número do Processo:</strong>
					...
					<div class="col-md-6"><strong>Número da Nota de Empenho:</strong>
					  <input type="text" class="form-control" id="NumeroNotaEmpenho" name="NumeroNotaEmpenho" placeholder="Número da Nota de Empenho" value="<?php echo $ped['NumeroNotaEmpenho']; ?>">
					</div>
				  </div>
                  
                   <div class="form-group">
					<div class="col-md-offset-2 col-md-6"><strong>Data de Emissão da Nota de Empenho:</strong>
					  <input type="date" class="form-control" id="DataEmissaoNotaEmpenho" name="DataEmissaoNotaEmpenho" placeholder="Data de Emissao da Nota de Empenho" value="<?php echo $ped['DataEmissaoNotaEmpenho']; ?>">
					</div>
					<div class="col-md-6"><strong>Data de Entrega da Nota de Empenho:</strong>
					  <input type="date" class="form-control" id="DataEntregaNotaEmpenho" name="DataEntregaNotaEmpenho" placeholder="Data de Entrega da Nota de Empenho" value="<?php echo $ped['DataEntregaNotaEmpenho']; ?>">
					</div>
				  </div>                  
