...
case "novoUser": // INSERIR NOVO USUARIO 
	...
	if(isset($_POST['atualizar'])){
		...
		if($existe['numero'] == 0){
			$sql_inserir = "INSERT INTO `ig_usuario` (`idUsuario`, `ig_papelusuario_idPapelUsuario`, `senha`, `receberNotificacao`, `nomeUsuario`, `email`, `nomeCompleto`, `idInstituicao`, `telefone`, `publicado`, `rf`) VALUES (NULL, '$perfil', '$senha', '$receberEmail', '$usuario', '$email', '$nomeCompleto', '$instituicao', '$telefone', '$publicado', '$rf')";
	...
	<form method="POST" action="?perfil=administrador&p=novoUser" class="form-horizontal" role="form">
			...
			<div class="col-md-offset-1 col-md-10">  
				...
				<div class="col-md-offset-2 col-md-8">
                		...
                		<input type="text" name="rf" class="form-control"id="rf" value="" />  </div> 
                	<div class="col-md-offset-2 col-md-8">
                		<label>Usuario:</label>
