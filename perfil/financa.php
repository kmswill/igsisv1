...
$sql = "SELECT idPedidoContratacao, tipoPessoa, idPessoa, aprovacaoFinanca FROM igsis_pedido_contratacao WHERE publicado = '1' AND instituicao = '$idInstituicao' ORDER BY idPedidoContratacao DESC";
}
