    ...
    <div class="container">
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-8">
	            ...
	            <a href="?perfil=ocupacao&p=carregar" class="btn btn-theme btn-lg btn-block">Carregar um evento gravado</a>
  	            <a href="?perfil=ocupacao&p=enviados" class="btn btn-theme btn-lg btn-block">Acompanhar andamento de eventos enviados</a>
            </div>
          </div>
        </div>
    </div>
...
?>
<?php
include "../include/menuOcupacao.php";
...
?>
<?php include "../include/menuOcupacaoDetalhe.php" ?>
<section id="inserir" class="home-section bg-white">
    ...
    <div class="row">
        ...
        <form method="POST" action="?perfil=ocupacao&p=basica" class="form-horizontal" role="form">
       		 <div class="form-group">
            	<div class="col-md-offset-2 col-md-8">
...
<section id="inserir" class="home-section bg-white">
    ...
    <div class="row">
        <div class="col-md-offset-1 col-md-10">
        <form method="POST" action="?perfil=ocupacao&p=detalhe" class="form-horizontal" role="form">
       		 <div class="form-group">
            	<div class="col-md-offset-2 col-md-8">
            		<label>Autor*</label>
...
<section id="inserir" class="home-section bg-white">
    ...
    <div class="row">
        <div class="col-md-offset-1 col-md-10">
        <form method="POST" action="?perfil=ocupacao&p=conteudo" class="form-horizontal" role="form">
       		 <div class="form-group">
            	<div class="col-md-offset-2 col-md-8">
            		<label>Sinopse *</label>
            		<textarea name="sinopse" class="form-control" rows="10" placeholder="Texto para divulgação e sob editoria da area de comunicação. Não ultrapassar 400 caracteres."><?php echo $campo["sinopse"] ?></textarea>
...
<section id="inserir" class="home-section bg-white">
    ...
    <div class="row">
        <div class="col-md-offset-1 col-md-10">
        <form method="POST" action="?perfil=ocupacao&p=internos" class="form-horizontal" role="form">
       		 <div class="form-group">
            	<div class="col-md-offset-2 col-md-8">
...
<section id="inserir" class="home-section bg-white">
    ...
    <div class="row">
        ...
        <div class="col-md-offset-1 col-md-10">
	       <form method="POST" action="?perfil=ocupacao&p=area" class="form-horizontal" role="form">
...
<section id="inserir" class="home-section bg-white">
    ...
    <div class="row">
        <div class="col-md-offset-1 col-md-10">
        <form method="POST" action="?perfil=ocupacao&p=externos" class="form-horizontal" role="form">
       		 <div class="form-group">
            	<div class="col-md-offset-2 col-md-8">
            	</div> 
            </div>
...
<br />
<div class = "center">
<form method='POST' action="?perfil=ocupacao&p=arquivos" enctype='multipart/form-data'>
...
break;
case "ocorrencias" :
include "../include/menuOcupacaoDetalhe.php";
...
if(isset($_POST['inserir'])){
	...
	if(mysqli_query($con,$sql_inserir)){
		...
		atualizarAgenda($_SESSION['idEvento']);
...
<section id="inserir" class="home-section bg-white">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-offset-1 col-md-10">
            <form method="POST" action="?perfil=ocupacao&p=ocorrencias&action=listar" class="form-horizontal" role="form">
...
?>
	...
	<section id="list_items" class="home-section bg-white">
		<div class="container">
			...
			<div class="table-responsive list_info">
                         <?php listaOcorrenciasOcupacao($_SESSION['idEvento']); ?>
			</div>
		</div>
	</section>
...
<section id="inserir" class="home-section bg-white">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-offset-1 col-md-10">
            <form method="POST" action="?perfil=ocupacao&p=ocorrencias" class="form-horizontal" role="form">
     <div class="form-group">
           	<div class="col-md-offset-2 col-md-8">
...
?>
    ...
    <div class="row">
        ...
        <div class="col-md-offset-1 col-md-10">
	       <form method="POST" action="?perfil=ocupacao&p=subEvento&action=inserir" class="form-horizontal" role="form">
...
case "evento":
 ?>
			  <h5>Dados do evento | <a href="?perfil=ocupacao&p=enviar&action=servicos">Solicitação de serviços</a> | <a href="?perfil=ocupacao&p=enviar&action=pedidos">Pedidos de contratação</a> |  <a href="?perfil=ocupacao&p=enviar&action=pendencias">Pendências</a></h5>
			<div class="table-responsive list_info" >
...
?>
			  <h5> <a href="?perfil=ocupacao&p=enviar&action=evento">Dados do evento </a>| <a href="?perfil=ocupacao&p=enviar&action=servicos">Solicitação de serviços</a> | Pedidos de contratação  |  <a href="?perfil=ocupacao&p=enviar&action=pendencias">Pendências</a></h5>
			  <div class="table-responsive list_info" >
<?php if($pedido != NULL){ ?>
...
?>    
			  <h5> <a href="?perfil=ocupacao&p=enviar&action=evento">Dados do evento </a>| Solicitação de serviços | <a href="?perfil=ocupacao&p=enviar&action=pedidos">Pedidos de contratação</a>  |  <a href="?perfil=ocupacao&p=enviar&action=pendencias">Pendências</a></h5>
			<div class="table-responsive list_info" >
            <h4><?php echo $evento['nomeEvento'] ?></h4>
            <div class="left">
...
?>   
			  <h5> <a href="?perfil=ocupacao&p=enviar&action=evento">Dados do evento </a>| <a href="?perfil=ocupacao&p=enviar&action=servicos">Solicitação de serviços</a> | <a href="?perfil=ocupacao&p=enviar&action=pedidos">Pedidos de contratação</a>  |  Pendências</h5>
			<div class="table-responsive list_info" >
            <h4><?php echo $evento['nomeEvento'] ?></h4>
            <div class="left">
...
?></p>
            ...
            <br />
                          ...
                          <div class="form-group">
            <div class="col-md-offset-2 col-md-8">
	          <form method='POST' action='?perfil=ocupacao&p=finalizar'>
	 ...
	 <section id="services" class="home-section bg-white">
		<div class="container">
            ...
            <h5><?php if(isset($mensagem)){ echo $mensagem; } ?>
                        <form method="POST" action="?perfil=ocupacao&p=busca" class="form-horizontal" role="form">
